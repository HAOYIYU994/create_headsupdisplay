...
public class CannonUtil {
    ...
    public static float getRotarySpeed( AbstractMountedCannonContraption contraptionEntity) {
        ...
        LOGGER.debug("Rotary cannon presentBlockEntities count = {}", presentBlockEntities.size());
    ...
    public static float getInitialVelocity(AbstractMountedCannonContraption cannon, ServerLevel level) {
        LOGGER.debug("Resolving initial velocity for contraption={} mods: BigCannon={}, AutoCannon={}, Rotary={}, Medium={}, Energy={}",
        ...
        if (isBigCannon(cannon)) {
            ...
            LOGGER.debug("TwinAutocannon speed = {}", getAutoCannonSpeed(cannon));
            return getAutoCannonSpeed(cannon);
        } else if(isHeavyAutocannon(cannon)){
            LOGGER.debug("HeavyAutocannon speed = {}", getAutoCannonSpeed(cannon));
            return getAutoCannonSpeed(cannon);
        }
